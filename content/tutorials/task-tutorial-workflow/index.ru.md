...
2.  [**Запланированная задача**](https://docs.nocobase.com/handbook/workflow/triggers/schedule): Автоматически срабатывает в указанное время, подходит для автоматизации по расписанию.
...
В будущих случаях вы также можете встретить такие типы триггеров, как "Событие до действия", "Событие пользовательского действия" и "Согласование", которые можно разблокировать с помощью дополнительных плагинов.
...
Измените содержание сообщения на: "Задача «【Название задачи】» была переназначена на: 【Исполнитель задачи / Имя】."
...
Отлично! Вы успешно создали автоматизированный рабочий процесс, который срабатывает на основе изменений владельца задачи. Эта функция не только экономит время, но и улучшает командную работу. На этом этапе наша система управления задачами приобрела мощные возможности.

---

### Заключение и следующие шаги

Вы завершили создание полностью функциональной системы управления задачами с нуля — охватывая создание задач, комментарии, права ролей, рабочие процессы и системные уведомления.

Гибкость и расширяемость NocoBase открывают для вас безграничные возможности. В будущем вы можете изучить больше плагинов, настроить функции или создать сложную бизнес-логику. С этими знаниями вы освоили основы и ключевые концепции NocoBase.

Мы с нетерпением ждем ваших следующих инноваций! При возникновении вопросов обращайтесь к [официальной документации NocoBase](https://docs.nocobase.com/) или присоединяйтесь к [сообществу NocoBase](https://forum.nocobase.com/) для обсуждений.

Продолжайте исследовать и раскрывайте бесконечный потенциал!