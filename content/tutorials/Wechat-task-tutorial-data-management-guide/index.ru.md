...
> **О Источниках данных:** Источник данных — это место, где хранятся коллекции. Это может быть база данных, API или другие типы хранилищ. NocoBase поддерживает различные реляционные базы данных, включая MySQL, PostgreSQL, SQLite и MariaDB.
>
...
В NocoBase все коллекции хранятся внутри **[Источников данных](https://docs.nocobase.com/handbook/data-source-manager)**, служат хранилищами, содержащими структуру и настройки каждой коллекции. Давайте добавим нашу новую главу, создав **коллекцию задач**.
...
Теперь давайте создадим третью коллекцию — нашу **коллекцию задач**. Мы будем использовать подход из предыдущего проекта, чтобы создать простую коллекцию задач со следующими полями:
...
По мере того как вы становитесь более опытным пользователем NocoBase, вот небольшое испытание: добавьте статус задачи и возможность прикреплять файлы.
...
Есть идеи? Не беспокойтесь, [следующая глава (Глава 4: Использование плагинов для задач и комментариев)](https://www.nocobase.com/en/tutorials/task-tutorial-plugin-use) раскроет ответ. Оставайтесь с нами!

### Продолжайте исследовать

Смело обращайтесь к [Документации NocoBase](https://docs.nocobase.com/) или присоединяйтесь к [Сообществу NocoBase](https://forum.nocobase.ru/), если у вас возникнут вопросы!
