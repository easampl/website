...
### 1.3 Настройка интерфейса проверки регистрации (Ядро)
...
### 1.6 Расширение полей коллекции «Пользователи» (Опционально)
...
#### 1.6.2 Включение поля в «Аутентификации пользователя»
...
*   **Идея настройки**: Combine узел отправки email в NocoBase, чтобы добавить операции отправки писем в рабочий процесс.

---

Если вы столкнетесь с какими-либо проблемами, не стесняйтесь посетить [сообщество NocoBase](https://forum.nocobase.com) или обратиться к [официальной документации](https://docs.nocobase.com). Мы надеемся, что это руководство поможет вам успешно реализовать проверку регистрации пользователей в соответствии с вашими фактическими потребностями и обеспечит гибкость для дальнейшего расширения. Желаем вам беспроблемного использования и успехов в проекте!